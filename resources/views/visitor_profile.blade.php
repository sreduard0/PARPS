    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button id="crop_image" class="btn btn-success">Pronto</button>
            </div>
        </div>
    </div>
</div>
{{-- Modal de envio de imagem para editar --}}
<div id="uploadnewimage" class="modal" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Ajustar nova imagem</h4>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
                <button id="crop_new_image" class="btn btn-success">Pronto</button>
            </div>
        </div>
    </div>
</div>
                            ...
                            <div class="widget-user-image">
                                ...
                                <div class="panel-body">
                                    <div class="fabE">
                                        ...
                                        <ul>
                                            <li>
                                                <label for="upload_new_image"><i
                                                        class="m-l-13 m-t-9 fas fa-file-image"></i></label>
                                                <input type="file" class="btn btn-success input-img-profile"
                                                    name="upload_new_image" id="upload_new_image"
                                                    accept="image/png,image/jpg,image/jpeg" />
                                            </li>
                                            <li>
                                                <button onclick="return loadCamera('e');" data-toggle="modal"
                                                    data-target="#webcam">
                                                    <i class="fas fa-camera"></i>
                                                </button>
                                            </li>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title card-title-background "> <i
                                                    class="fas fa-user mr-1"></i>
                                                Empresa</h3>
                                            <button class="btn btn-default float-r"
                                                onclick="return editenterprise()"><i class="fa fa-pen"></i></button>
                                        </div>
                                        <div class="card-body">
                                            <div class="card-body">
                                                <div class="  float-l col-md-6">
...
<!-- Modal webcam -->
<div class="modal fade" id="webcam" tabindex="-1" role="dialog" aria-labelledby="webcamLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="webcamLabel">Tirar foto do visitante</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <div class="modal-content">
                        ...
                        <div class="row">
                            <div class="col form-group ">
                                ...
                                <input type="text" class="form-control"
                                    data-inputmask="'mask': ['999.999.999-99']" inputmode="text" data-mask=""
                                    id="edit_cpf" name="edit_cpf" placeholder="CPF" value="">
                            </div>
                            <div class="col form-group ">
                                <label for="edit_phone">Telefone</label>
                                <input type="text" class="form-control"
                                    data-inputmask="'mask': ['(99) 9 9999-9999']" inputmode="text" data-mask=""
                                    id="edit_phone" name="edit_phone" placeholder="Telefone" value="">
                            </div>
                        </div>
                </div>
                </form>
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success"
                        onclick="return edit_info_visitor()">Alterar</button>
                </div>
            </div>
        </div>
    </div>
